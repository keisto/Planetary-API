...
app.config['JWT_SECRET_KEY'] = 'super-secret'  # TODO: secret key or uuid in production
app.config['MAIL_SERVER'] = 'smtp.mailtrap.io'
app.config['MAIL_PORT'] = 2525
app.config['MAIL_USERNAME'] = os.environ['MAIL_USERNAME']  # 2dff24b3616d91
app.config['MAIL_PASSWORD'] = os.environ['MAIL_PASSWORD']  # 795db649599218
...
def db_seed():
    ...
    test_user = User(first_name="Tony", last_name="Keiser", email="keisertony@gmail.com", password="reaper")
...
def super_simple():
    return jsonify(message="Test"), 200  # default === 2000
